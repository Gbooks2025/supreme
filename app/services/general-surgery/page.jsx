"use client";
import { Heart, Award, Clock, Users, Phone, Mail, MapPin, ArrowRight, Check, Activity, Stethoscope, Calendar, FileText, TrendingUp, Zap, Scissors } from 'lucide-react';
...
export default function GeneralSurgery() {
  ...
  const diagnosticServices = [
    {
      ...
      description: 'Minimally invasive keyhole surgery with 0.5-1.5cm incisions for reduced pain, faster recovery, less scarring, and shorter hospital stay compared to open surgery'
    },
    {
      name: 'Appendectomy',
      description: 'Surgical removal of inflamed appendix for acute appendicitis through laparoscopic or open approach with same-day or next-day discharge in uncomplicated cases'
    },
    {
      name: 'Cholecystectomy (Gallbladder Removal)',
      description: 'Laparoscopic gallbladder removal for gallstones, cholecystitis, and biliary colic with 30-60 minute procedure time and rapid return to normal activities'
    },
    {
      name: 'Hernia Repair Surgery',
      description: 'Inguinal, femoral, umbilical, and incisional hernia repair with mesh placement using open or laparoscopic technique for permanent defect correction'
    },
    {
      name: 'Thyroid Surgery (Thyroidectomy)',
      description: 'Partial or total thyroid gland removal for thyroid nodules, goiter, hyperthyroidism, and thyroid cancer with nerve monitoring and parathyroid preservation'
    },
    {
      name: 'Breast Surgery',
      description: 'Lumpectomy, mastectomy, and breast biopsy for breast cancer and benign breast disease with oncoplastic reconstruction options'
    },
    {
      name: 'Gastrointestinal Surgery',
      description: 'Bowel resection, colectomy, and abdominal surgery for inflammatory bowel disease, diverticulitis, and gastrointestinal tumors'
    },
    {
      name: 'Emergency Surgery',
      description: '24/7 emergency surgical services for acute abdomen, trauma, perforated ulcer, intestinal obstruction, and life-threatening conditions'
    }
  ];
  ...
  const clinicalConditions = [
    {
      ...
      details: 'Emergency appendectomy within 24 hours of diagnosis using laparoscopic approach with diagnostic accuracy, reduced wound infections, and faster recovery compared to open surgery'
    },
    {
      condition: 'Gallstones and Cholecystitis',
      details: 'Laparoscopic cholecystectomy for symptomatic gallstones and acute cholecystitis as gold standard treatment with shorter hospital stay and quicker return to work'
    },
    {
      condition: 'Inguinal and Femoral Hernia',
      details: 'Hernia repair with non-absorbable mesh placement through open or laparoscopic technique under general, regional, or local anesthesia with 30-minute procedure time'
    },
    {
      condition: 'Incisional Hernia',
      details: 'Repair of abdominal wall defects after previous surgery using laparoscopic approach for hernias <10cm or open surgery for larger defects with mesh reinforcement'
    },
    {
      condition: 'Thyroid Nodules and Goiter',
      details: 'Total or partial thyroidectomy for nodules, multinodular goiter, hyperthyroidism, and thyroid cancer with careful nerve preservation and calcium monitoring'
    },
    {
      condition: 'Breast Cancer',
      details: 'Breast-conserving surgery (lumpectomy) or mastectomy with sentinel lymph node biopsy or axillary dissection, followed by reconstruction options'
    },
    {
      condition: 'Inflammatory Bowel Disease',
      details: 'Surgical management of Crohn\'s disease and ulcerative colitis complications including strictures, fistulas, and refractory disease with bowel resection'
    },
    {
      condition: 'Diverticulitis',
      details: 'Colectomy and bowel resection for complicated diverticulitis with abscess, perforation, or recurrent attacks requiring surgical intervention'
    },
    {
      condition: 'Gastroesophageal Reflux Disease (GERD)',
      details: 'Laparoscopic fundoplication as gold standard surgical treatment with symptom reduction, faster recovery, and improved quality of life over medical therapy'
    },
    {
      condition: 'Intestinal Obstruction',
      details: 'Emergency or elective surgery for small bowel or large bowel obstruction due to adhesions, hernias, tumors, or volvulus with bowel resection if needed'
    }
  ];
  ...
  const treatmentPrograms = [
    {
      ...
      items: [
        'Laparoscopic cholecystectomy (gallbladder removal) with faster recovery',
        'Laparoscopic appendectomy with reduced wound infections',
        'Laparoscopic hernia repair with mesh placement',
        'Laparoscopic fundoplication for GERD treatment'
      ]
    },
    {
      category: 'Open Surgery',
      items: [
        'Complex hernia repair with mesh reinforcement',
        'Bowel resection and colectomy for cancer and IBD',
        'Thyroidectomy with nerve monitoring',
        'Emergency laparotomy for acute abdomen and trauma'
      ]
    },
    {
      category: 'Specialized Procedures',
      items: [
        'Breast cancer surgery: lumpectomy and mastectomy',
        'Abdominal wall reconstruction for incisional hernias',
        'Small bowel resection for obstruction and strictures',
        'Colorectal surgery for diverticulitis and tumors'
      ]
    }
  ];
  ...
  const teamMembers = [
    {
      name: 'Dr. General Surgery Specialist',
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              <div className={`inline-flex items-center gap-2 px-4 py-2 rounded-full border backdrop-blur-sm mb-6 transition-all duration-300 ${isDark ? 'bg-emerald-500/15 border-emerald-500/30' : 'bg-emerald-100/70 border-emerald-300/60'}`}>
                <Scissors className={`w-4 h-4 ${isDark ? 'text-emerald-400' : 'text-emerald-600'}`} />
                <span className={`text-sm font-semibold ${isDark ? 'text-emerald-300' : 'text-emerald-700'}`}>GENERAL SURGERY DEPARTMENT</span>
              </div>
              ...
              <p className={`text-xl transition-colors duration-300 mb-8 ${isDark ? 'text-gray-300' : 'text-gray-600'}`}>
                Comprehensive general and laparoscopic surgery services providing minimally invasive procedures for faster recovery including appendectomy, gallbladder removal, hernia repair, and emergency surgical interventions.
              </p>

              <div className="flex flex-wrap gap-6 mb-8">
                <div>
                  <p className="text-4xl font-black bg-gradient-to-r from-emerald-600 to-cyan-600 bg-clip-text text-transparent">21+</p>
                  <p className={`text-sm font-medium transition-colors duration-300 ${isDark ? 'text-gray-400' : 'text-gray-600'}`}>Years Experience</p>
                </div>
                <div>
                  <p className="text-4xl font-black bg-gradient-to-r from-emerald-600 to-cyan-600 bg-clip-text text-transparent">10k+</p>
                  <p className={`text-sm font-medium transition-colors duration-300 ${isDark ? 'text-gray-400' : 'text-gray-600'}`}>Surgeries Done</p>
                </div>
                <div>
                  <p className="text-4xl font-black bg-gradient-to-r from-emerald-600 to-cyan-600 bg-clip-text text-transparent">24/7</p>
                  <p className={`text-sm font-medium transition-colors duration-300 ${isDark ? 'text-gray-400' : 'text-gray-600'}`}>Emergency Surgery</p>
                </div>
              </div>
            ...
            <div className="hidden lg:flex items-center justify-center">
              <div className="relative w-80 h-80 rounded-3xl flex items-center justify-center text-9xl bg-gradient-to-br from-emerald-600 to-cyan-600 shadow-2xl shadow-emerald-600/30">
                <Scissors className="w-48 h-48 text-white animate-pulse" />
              </div>
            </div>
          </div>
        </div>
            ...
            {[
              {
                ...
                desc: 'Advanced laparoscopic techniques for faster recovery and reduced complications'
              },
              {
                icon: TrendingUp,
                title: 'Comprehensive Surgery',
                desc: 'Complete range of general surgery procedures from elective to emergency operations'
              },
              {
                icon: Users,
                title: 'Expert Surgeons',
                desc: 'Highly qualified surgical specialists with extensive training in modern techniques'
              }
            ].map((item, idx) => {
        ...
        <div className="max-w-7xl mx-auto">
          <div className="mb-16">
            ...
            <p className={`text-lg transition-colors duration-300 ${isDark ? 'text-gray-300' : 'text-gray-600'}`}>
              Comprehensive general and laparoscopic surgical procedures for all abdominal and soft tissue conditions
            </p>
          </div>
      ...
      <section className={`relative py-24 px-4 sm:px-6 lg:px-8 transition-colors duration-300 ${isDark ? 'bg-slate-900/50' : 'bg-gray-50'}`}>
        <div className="max-w-7xl mx-auto">
          <div className="mb-16">
            ...
            <p className={`text-lg transition-colors duration-300 ${isDark ? 'text-gray-300' : 'text-gray-600'}`}>
              Expert surgical management of all general surgery conditions
            </p>
          </div>
      ...
      <section className={`relative py-24 px-4 sm:px-6 lg:px-8 overflow-hidden bg-gradient-to-r from-emerald-600 to-cyan-600`}>
        ...
        <div className="relative max-w-4xl mx-auto text-center">
          <h2 className="text-5xl font-black text-white mb-8">
            Expert Surgical Care Available 24/7
          </h2>
          <p className="text-xl text-white/90 mb-12">
            Our surgical specialists provide comprehensive general and laparoscopic surgery with minimally invasive techniques for faster recovery and excellent outcomes.
          </p>
