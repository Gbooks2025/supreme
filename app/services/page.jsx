...
export default function Services() {
  ...
  const services = [
    ...
    // Pharmacy Services
    {
      ...
      shortDesc: '24/7 Medicine Availability',
      fullDesc: 'Round-the-clock pharmacy with genuine medicines and prescription management',
      category: 'pharmacy',
      features: ['24/7 Availability', 'Prescription Management', 'Generic Medicines', 'Medicine Delivery'],
      route: '/services/pharmacy'
    },
    {
      icon: Pill,
      title: 'Medicine Home Delivery',
      shortDesc: 'Doorstep Medicine Service',
      fullDesc: 'Convenient home delivery of medicines with prescription tracking',
      category: 'pharmacy',
      features: ['Same Day Delivery', 'Prescription Tracking', 'Online Orders', 'Medicine Reminders'],
    ...
    // Dialysis Services
    {
      icon: Droplet,
      title: 'Hemodialysis',
      shortDesc: 'Advanced Kidney Dialysis',
      fullDesc: 'State-of-the-art hemodialysis services for acute and chronic kidney failure',
      category: 'dialysis',
      features: ['Modern Equipment', 'Experienced Staff', 'Regular Sessions', 'Emergency Dialysis'],
      route: '/services/hemodialysis'
    },
    {
      icon: Droplet,
      title: 'Peritoneal Dialysis',
      shortDesc: 'Home-Based Dialysis',
      fullDesc: 'Training and support for peritoneal dialysis at home',
      category: 'dialysis',
      features: ['Home Training', 'Regular Monitoring', 'Supplies Management', '24/7 Support'],
      route: '/services/peritoneal-dialysis'
    }
  ];
    ...
    <div className={`overflow-hidden transition-colors duration-300 ${isDark ? 'bg-slate-950' : 'bg-white'}`}>
      ...
      <section className={`relative py-24 px-4 sm:px-6 lg:px-8 pt-32 transition-colors duration-300 ${isDark ? 'bg-gradient-to-b from-slate-950 to-slate-900' : 'bg-gradient-to-b from-white to-gray-50'}`}>
        ...
        <div className="relative max-w-7xl mx-auto text-center">
          ...
          <p className={`text-xl max-w-2xl mx-auto transition-colors duration-300 ${isDark ? 'text-gray-300' : 'text-gray-600'}`}>
            Comprehensive healthcare solutions with 18+ specialized departments, pharmacy and dialysis services
          </p>
        </div>
      </section>
      ...
      <section className={`relative py-12 px-4 sm:px-6 lg:px-8 transition-colors duration-300 ${isDark ? 'bg-slate-900/50' : 'bg-gradient-to-b from-gray-50 to-white'}`}>
        <div className="max-w-7xl mx-auto">
          <div className="flex flex-wrap justify-center gap-3">
            {[
              { id: 'all', label: 'All Services' },
              { id: 'doctors-clinic', label: 'Doctors Clinic' },
      ...
      <section className={`relative py-24 px-4 sm:px-6 lg:px-8 overflow-hidden transition-colors duration-300 ${isDark ? 'bg-gradient-to-r from-emerald-600 to-cyan-600' : 'bg-gradient-to-r from-emerald-600 to-cyan-600'}`}>
        ...
        <div className="relative max-w-4xl mx-auto text-center">
          <h2 className="text-5xl font-black text-white mb-8">Ready to Get Quality Healthcare?</h2>
          <p className="text-xl text-white/90 mb-12">
            Choose from our 18+ specialized departments, pharmacy and dialysis services
          </p>
