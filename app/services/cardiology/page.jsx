...
export default function Cardiology() {
  ...
  const diagnosticServices = [
    {
      name: '12-Lead Electrocardiography (ECG)',
      description: 'Standard resting ECG for detecting arrhythmias, myocardial infarction, and electrolyte disturbances'
    },
    {
      name: 'Transthoracic Echocardiography (2D Echo)',
      description: 'Real-time visualization of cardiac structures, function, and blood flow dynamics'
    },
    {
      name: 'Stress Testing (Treadmill & Pharmacological)',
      description: 'Assessment of cardiac function during increased demand and detection of inducible ischemia'
    },
    {
      name: '24-Hour Holter Monitoring',
      description: 'Continuous cardiac rhythm monitoring for detection of paroxysmal arrhythmias and ischemic episodes'
    },
    {
      name: 'Coronary Angiography',
      description: 'Invasive imaging for definitive diagnosis of coronary artery disease and assessment of collateral circulation'
    },
    {
      name: 'Percutaneous Coronary Intervention (PCI)',
      description: 'Catheter-based revascularization with stent placement for acute and chronic coronary syndromes'
    },
    {
      name: 'Cardiac CT Angiography (CCTA)',
      description: 'Non-invasive volumetric imaging for coronary artery assessment and cardiac structure evaluation'
    },
    {
      name: 'Cardiac Magnetic Resonance Imaging (CMR)',
      description: 'Advanced tissue characterization for assessment of myocardial viability and fibrosis'
    }
  ];
  ...
  const clinicalConditions = [
    {
      ...
      details: 'Including STEMI and NSTEMI with evidence-based reperfusion therapy and contemporary antithrombotic management'
    },
    {
      condition: 'Chronic Stable Angina',
      details: 'Risk stratification and optimal medical management with pharmacological and interventional options'
    },
    {
      condition: 'Heart Failure with Reduced Ejection Fraction (HFrEF)',
      details: 'Comprehensive management including ACE inhibitors, beta-blockers, aldosterone antagonists, and device therapy'
    },
    {
      condition: 'Heart Failure with Preserved Ejection Fraction (HFpEF)',
      details: 'Targeted therapy addressing underlying mechanisms and comorbidity management'
    },
    {
      condition: 'Atrial Fibrillation',
      details: 'Rhythm and rate control strategies with appropriate anticoagulation and ablation procedures'
    },
    {
      condition: 'Ventricular Arrhythmias',
      details: 'Assessment and management including ICD/pacemaker implantation and catheter ablation'
    },
    {
      condition: 'Hypertension',
      details: 'Comprehensive risk assessment and individualized antihypertensive therapy'
    },
    {
      condition: 'Dyslipidemia',
      details: 'Management with statins, PCSK9 inhibitors, and other lipid-modifying agents'
    },
    {
      condition: 'Valvular Heart Disease',
      details: 'Diagnosis and management of stenosis and regurgitation with surgical and transcatheter intervention options'
    },
    {
      condition: 'Pulmonary Hypertension',
      details: 'Classification and targeted pulmonary vasodilator therapy'
    }
  ];
  ...
  const preventionPrograms = [
    {
      ...
      items: [
        'Cardiovascular risk assessment using Framingham and ASCVD risk calculators',
        'Intensive lifestyle modification counseling (diet, exercise, smoking cessation)',
        'Aspirin therapy for high-risk patients per current guidelines',
        'Statin therapy initiation based on LDL-C goals'
      ]
    },
    {
      category: 'Secondary Prevention',
      items: [
        'Post-MI risk stratification and exercise-based cardiac rehabilitation',
        'Intensive blood pressure management (target <130/80 mmHg)',
        'Tight glycemic control in diabetic patients',
        'Comprehensive lipid management with high-intensity statins'
      ]
    },
    {
      category: 'Lifestyle Modification',
      items: [
        'Mediterranean diet and DASH diet recommendations',
        'Structured exercise prescription (150 min moderate-intensity aerobic activity weekly)',
        'Weight management and BMI optimization',
        'Stress reduction and meditation programs'
      ]
    }
  ];
  ...
  const teamMembers = [
    {
      ...
      qualification: 'MD (Cardiology), FACC, FESC',
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              <div className={`inline-flex items-center gap-2 px-4 py-2 rounded-full border backdrop-blur-sm mb-6 transition-all duration-300 ${isDark ? 'bg-emerald-500/15 border-emerald-500/30' : 'bg-emerald-100/70 border-emerald-300/60'}`}>
                ...
                <span className={`text-sm font-semibold ${isDark ? 'text-emerald-300' : 'text-emerald-700'}`}>CARDIOLOGY DEPARTMENT</span>
              </div>
              ...
              <p className={`text-xl transition-colors duration-300 mb-8 ${isDark ? 'text-gray-300' : 'text-gray-600'}`}>
                Comprehensive cardiovascular care utilizing evidence-based clinical protocols, advanced diagnostic modalities, and contemporary therapeutic interventions for optimal patient outcomes.
              </p>
              ...
              <div className="flex flex-wrap gap-6 mb-8">
                ...
                <div>
                  <p className="text-4xl font-black bg-gradient-to-r from-emerald-600 to-cyan-600 bg-clip-text text-transparent">2500+</p>
                  <p className={`text-sm font-medium transition-colors duration-300 ${isDark ? 'text-gray-400' : 'text-gray-600'}`}>Procedures Performed</p>
                </div>
                <div>
                  <p className="text-4xl font-black bg-gradient-to-r from-emerald-600 to-cyan-600 bg-clip-text text-transparent">FACC</p>
            ...
            {[
              {
                ...
                desc: 'State-of-the-art imaging and testing facilities for accurate cardiac assessment'
              },
              {
                icon: TrendingUp,
                title: 'Evidence-Based Treatment',
                desc: 'Contemporary therapeutic protocols adhering to ACC/AHA guidelines'
              },
              {
                icon: Users,
                title: 'Multidisciplinary Team',
                desc: 'Collaborative care involving interventional cardiologists and support specialists'
              }
            ].map((item, idx) => {
        ...
        <div className="max-w-7xl mx-auto">
          <div className="mb-16">
            ...
            <p className={`text-lg transition-colors duration-300 ${isDark ? 'text-gray-300' : 'text-gray-600'}`}>
              Comprehensive cardiovascular diagnostic capabilities utilizing current technology and clinical expertise
            </p>
          </div>
      ...
      <section className={`relative py-24 px-4 sm:px-6 lg:px-8 transition-colors duration-300 ${isDark ? 'bg-slate-900/50' : 'bg-gray-50'}`}>
        <div className="max-w-7xl mx-auto">
          <div className="mb-16">
            ...
            <p className={`text-lg transition-colors duration-300 ${isDark ? 'text-gray-300' : 'text-gray-600'}`}>
              Expert management of the full spectrum of cardiovascular pathology
            </p>
          </div>
      ...
      <section className={`relative py-24 px-4 sm:px-6 lg:px-8 transition-colors duration-300 ${isDark ? 'bg-slate-950' : 'bg-white'}`}>
        <div className="max-w-7xl mx-auto">
          <h2 className={`text-5xl font-black mb-16 transition-colors duration-300 ${isDark ? 'text-white' : 'text-gray-900'}`}>
            Prevention & Risk Modification Programs
          </h2>
      ...
      <section className={`relative py-24 px-4 sm:px-6 lg:px-8 overflow-hidden bg-gradient-to-r from-emerald-600 to-cyan-600`}>
        ...
        <div className="relative max-w-4xl mx-auto text-center">
          <h2 className="text-5xl font-black text-white mb-8">
            Comprehensive Cardiac Management Awaits
          </h2>
          <p className="text-xl text-white/90 mb-12">
            Our specialized cardiology team is committed to providing evidence-based, patient-centered care for optimal cardiovascular health outcomes.
          </p>
